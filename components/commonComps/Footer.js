    ...
    return (
        <div>
            <div className={styles.contactContainer} id='homecontactdiv'>
                ...
                <div className={styles.contactContent}>
                    <span><Image width={95} height={89} alt='icon' src={'/images/othericons/mail.png'}></Image></span>
                ...
                <div className={styles.contactContent}>
                    <span><Image width={95} height={89} alt='icon' src={'/images/othericons/instagramw.png'}></Image></span>
