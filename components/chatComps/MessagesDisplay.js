            ...
            {!hasPaired && isFindingPair && (
                <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <div style={{ fontFamily: 'Jost', display: 'flex', alignItems: 'center', padding:'0 1rem' }}>
                        <div style={{textAlign:'center'}}>Timing is key! <span style={{fontSize:'1.2rem'}}>6 PM</span> & <span style={{fontSize:'1.2rem'}}>10 PM</span> on MYM are like lucky hours for chats. Don’t miss it.</div>
                    </div>
